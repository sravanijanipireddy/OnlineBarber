...
import com.cg.servises.MycartService;
...
public class MycartController {
	...
	public ResponseEntity<MyCart> addBarbers (@RequestBody MyCart products)  {
		...
		ResponseEntity<MyCart> response= new ResponseEntity<MyCart>(products1, HttpStatus.OK);
		return response;
	}
...
//		http://localhost:8081/MyCartController/updateStatus/{Id}
		...
		public void updateAvlable(@PathVariable("Id")Integer Id , @RequestBody MyCart product) throws  No_Data_Found {
